...
st.set_page_config(page_title="HYAB Data Cleaner", page_icon="📊", layout="wide", initial_sidebar_state="collapsed")
...
:root {--navy: #1B2A41; --grey-warm: #F7F6F4; --grey-border: #E2E0DC; --grey-text: #6B7280; --teal: #4A9BA8; --success: #2D6A4F;}
#MainMenu, footer, header, .stDeployButton {display: none !important;}
section[data-testid="stSidebar"] {display: none;}
.stApp {background: var(--grey-warm);}
.hyab-header {background: var(--navy); padding: 14px 24px; margin: -1rem -1rem 1.5rem -1rem; display: flex; align-items: center; gap: 12px;}
...
.page-title {font-family: 'Libre Baskerville', Georgia, serif; font-size: 26px; font-style: italic; color: var(--navy); margin: 0 0 20px 0;}
.section-label {font-size: 11px; font-weight: 600; letter-spacing: 0.08em; text-transform: uppercase; color: var(--grey-text); margin: 0 0 10px 0;}
div[data-testid="stRadio"] > div {flex-direction: row !important; gap: 0 !important; background: white; border: 1px solid var(--grey-border); padding: 3px; width: fit-content;}
div[data-testid="stRadio"] > div > label {padding: 8px 18px !important; margin: 0 !important; font-size: 13px !important; font-weight: 500 !important; background: transparent !important;}
div[data-testid="stRadio"] > div > label[data-checked="true"] {background: var(--navy) !important; color: white !important;}
div[data-testid="stRadio"] > label {display: none !important;}
.stButton > button {background: var(--navy) !important; color: white !important; border: none !important; font-size: 14px !important; font-weight: 600 !important; height: 48px !important; width: 100% !important;}
.stDownloadButton > button {background: var(--success) !important; color: white !important; border: none !important; font-size: 14px !important; font-weight: 600 !important; height: 48px !important;}
div[data-testid="stMetric"] {background: white; padding: 16px; border-left: 3px solid var(--navy);}
.success-banner {display: flex; align-items: center; gap: 8px; padding: 10px 14px; background: #D8F3DC; color: var(--success); font-size: 12px; font-weight: 600; letter-spacing: 0.05em; text-transform: uppercase; margin-bottom: 16px;}
</style>
<div class="hyab-header"><span class="brand-mark">‹</span><span class="brand-text">HYAB</span><span class="brand-divider">/</span><span class="brand-page">Data Cleaner v3.0</span></div>
